...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <button onClick={handleSubmit} disabled={addingShow} className='bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/80 transition-all cursor-pointer'>Add Show</button>
    </>
  ) : <Loading />
}
